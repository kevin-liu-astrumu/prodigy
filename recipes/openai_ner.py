...
from recipes.azure_openai import OpenAISuggester, PromptExample, get_api_credentials
from recipes.azure_openai import load_template, normalize_label
from recipes.azure_openai import read_prompt_examples
...
def ner_openai_correct(
    ...
    api_key, url = get_api_credentials(model)
